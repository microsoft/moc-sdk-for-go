...
func (c *client) getPublicIPAddressRequestByName(opType wssdcloudcommon.Operation, location, name string) (*wssdcloudnetwork.PublicIPAddress, error) {
...
func (c *client) getPublicIPAddressRequest(opType wssdcloudcommon.Operation, location, name string, pip *network.PublicIPAddress) (*wssdcloudnetwork.PublicIPAddress, error) {
	...
	request := &wssdcloudnetwork.PublicIPAddressRequest{
		...
		PublicIPAddresss: []*wssdcloudnetwork.PublicIPAddress{},
	}
	var err error

	wssdCloudNSG, err := getWssdNetworkSecurityGroup(pip, location)
	if err != nil {
		return nil, err
	}

	request.PublicIPAddresss = append(request.PublicIPAddresss, wssdCloudNSG)
	return request, nil
}
